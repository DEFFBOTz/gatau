...
▒▒▒▒▒▒▒▒▒▒▒▐▒▒▒▒▌▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE © DEFFBOTzBotz
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE © DEFFBOTzBotz
SUBSCRIBE © DEFFBOTzBotz SUBSCRIBE © DEFFBOTzBotz SUBSCRIBE © DEFFBOTzBotz SUBSCRIBE © DEFFBOTzBotz
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz 
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz J
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JAN
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANG
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN 
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN D
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI 
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI J
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JU
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL 
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL S
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SE
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEM
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMB
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBAR
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARAN
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANG
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN S
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN SA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN SAY
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN SAYA
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN SAYAN
SUBSCRIBE © DEFFBOTz SUBSCRIBE © DEFFBOTz JANGAN DI JUAL SEMBARANGAN SAYANG
...
donname = setting.Donname
zerokey = setting.ZextzKey
...
noovo = setting.noovo
nodana = setting.nodana
creator = 'zextz ' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = '© DEFFBOTz ' // UBAH NAMA LU
const fakeimage = fs.readFileSync ('./media/deff.jpg')
const fakedhani = fs.readFileSync ('./media/deff.jpg')
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: '[]❕[] Done Jangan Lupa Subscribe © DEFFBOTz ',
			error: {
				stick: '[]❗[] Gagal Convert Gambar To Sticker...Coba Lagi !',
				Iv: '[]❗[] Linknya Error Om !'
			},
			only: {
				admin: '[]❗[] Kusus Admin  Om!',
				group: '[]❗[] Khusus Group  Om!'
			}
		}
		faketeks = '© DEFFBOTz '
		const isUrl = (url) => {
        ...
        const zero = fs.readFileSync ('./media/deff.jpg')
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
 const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝐀𝐋𝐋 𝐌𝐄𝐍𝐔","footerText": `Hallo Kak :v`,"listType": "SINGLE_SELECT","sections": list}}, {})
...
thumbnail: fs.readFileSync('./media/deff.jpg'),
...
const hideTag = async function(from, text){
           ...
           zeroyt7.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/deff.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}
...
case 'menu':
	reply('𖣘━━━╤╝ LOADING╚╤━━━?')
						        lima = fs.readFileSync('./assets/bot.mp3');
                    zeroyt7.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
 
 gambar = fs.readFileSync('./media/deff.jpg')
	menunya =
`
   HallO kak ${pushname}👋🏻 ${tampilUcapan}✨
...
│➸ 300 Commands
│➸ Cek Menu: #menu
│➸ Group BOT: gada GC gw Mah
│➸ YT BOT : https://youtube.com/channel/UCx6TnPIwwnMJM59XoUUInIw
...
`
but = [
          { buttonId: `${prefix}info`, buttonText: { displayText: '📄 𝙄𝙉𝙁𝙊' }, type: 1 },
          { buttonId: `${prefix}allmenu`, buttonText: { displayText: '🔰 𝘼𝙇𝙇𝙈𝙀𝙉𝙐' }, type: 1 },
          { buttonId: `${prefix}command`, buttonText: { displayText: '‍💼 𝙇𝙄𝙎𝙏𝙈𝙀𝙉𝙐' }, type: 1 }
        ]
        sendButImage(from, menunya, teks, gambar, but)
break
case 'allmenu':
reply('𖣘━━━╤╝ 𝙒𝘼𝙄𝙏 𝟛 𝘿𝙏𝙆 ╚╤━━━𖣘')
menu =`
   ☬ ━━━╤╝ 𝘼𝙇𝙇 𝙈𝙀𝙉𝙐 ╚╤━━━ ☬
   
   ${tampilUcapan} kak ${pushname}😇


╭─❒  ⌜ Group Menu ⌟ ❒
├₹⃟ぁ ➣${prefix}antilink
├₹⃟ぁ ➣${prefix}welcome
├₹⃟ぁ ➣${prefix}antivirtex
├₹⃟ぁ ➣${prefix}group
├₹⃟ぁ ➣${prefix}linkgrup
├₹⃟ぁ ➣${prefix}promote
├₹⃟ぁ ➣${prefix}demote
...
├₹⃟ぁ ➣${prefix}manga
├₹⃟ぁ ➣${prefix}anime
├₹⃟ぁ ➣${prefix}kusonimesearch
├₹⃟ぁ ➣${prefix}otakudesusearch
├₹⃟ぁ ➣${prefix}nhentaisearch
├₹⃟ぁ ➣${prefix}nekopoisearch
└❏
...
├₹⃟ぁ ➣${prefix}cuaca
├₹⃟ぁ ➣${prefix}covidindo
├₹⃟ぁ ➣${prefix}covidglobal
└❏

╭─❒ ⌜ Random Text Menu ⌟ ❒
├₹⃟ぁ ➣${prefix}quotes
├₹⃟ぁ ➣${prefix}quotesanime
├₹⃟ぁ ➣${prefix}quotesdilan
├₹⃟ぁ ➣${prefix}quotesimage
├₹⃟ぁ ➣${prefix}katabijak
├₹⃟ぁ ➣${prefix}randomnama
└❏

╭─❒ ⌜ Search Menu ⌟ ❒
├₹⃟ぁ ➣${prefix}gimage
├₹⃟ぁ ➣${prefix}wallpapersearch
├₹⃟ぁ ➣${prefix}playstore
├₹⃟ぁ ➣${prefix}shopee
├₹⃟ぁ ➣${prefix}google
└❏
...
╭─❒ ⌜ Asupan Menu ⌟ ❒
├₹⃟?? ➣${prefix}asupan
├₹⃟ぁ ➣${prefix}asupancecan
├₹⃟ぁ ➣${prefix}asupanhijaber
├₹⃟ぁ ➣${prefix}asupansantuy
├₹⃟ぁ ➣${prefix}asupanukhti
├₹⃟ぁ ➣${prefix}asupanbocil
├₹⃟ぁ ➣${prefix}asupanghea
├₹⃟ぁ ➣${prefix}asupanrika
└❏
...
*RECODE BY : DEFFBOTz*
`
zeroyt7.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}owner`, buttonText: { displayText: 'ᴏᴡɴᴇʀ' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: 'sᴇᴡᴀʙᴏᴛ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
case 'command':
               list = []
               listmenu = [`groupmenu`,`stikermenu`,`animemenu`,`bokepmenu`,`nekopoimenu`,`ownermenu`,`gamemenu`,`downloadmenu`,`infomenu`,`randomtextmenu`,`searchmenu`,`randomimagemenu`,`asupanmenu`,`cecanmenu`,`infobotmenu`]
               listmenuu = [`Menu Group`,`Sticker Menu`,`Anime Menu`,`Bokep Menu`,`Nekopoi Menu`,`Owner Menu`,`Kerang Menu`,`Downloader`,`Info Menu`,`Random Text Menu`,`Search Menu`,`Random Image Menu`,`Asupan Menu`,`Cecan Menu`,`Info Botz Menu`]
               nombor = 1
               startnum = 0
               ...
               listmsg(from, `*»[${botname}]«*`,  `_Hallo Kak* ${pushname}_\n_${tampilUcapan}✨_ `, list)
               break
...
│₹⃟ぁ ➣  ${prefix}hen 𝟙𝟘𝟘%
│₹⃟ぁ ➣  ${prefix}bugvn 𝟙𝟘𝟘%
│₹⃟ぁ ➣  ${prefix}bugvn2 𝟙𝟘𝟘%
│₹⃟ぁ ➣  ${prefix}xbug 𝟘%
│₹⃟ぁ ➣  ${prefix}bugpc 𝟘%
│₹⃟ぁ ➣  ${prefix}bugpc2 𝟘%
│₹⃟ぁ ➣  ${prefix}bugbrutal 𝟘%
│₹⃟ぁ ➣  ${prefix}bugrow 𝟘%
│₹⃟ぁ ➣  ${prefix}bugbutton 𝟘%
│₹⃟ぁ ➣  ${prefix}bug [Jumlah] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugv2 [Jumlah] 𝟘%
│₹⃟ぁ ➣  ${prefix}buggc [Jumlah] 𝟘%
│₹⃟ぁ ➣  ${prefix}sendbug [Jumlah]𝟘%
│₹⃟ぁ ➣  ${prefix}bugtext [Jumlah] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugstik 𝟘%
│₹⃟ぁ ➣  ${prefix}bugpdf 𝟘%
│₹⃟ぁ ➣  ${prefix}pdfvirus 𝟘%
│₹⃟ぁ ➣  ${prefix}pdfvirusreal 𝟘%
│₹⃟ぁ ➣  ${prefix}bugdoc 𝟘%
│₹⃟ぁ ➣  ${prefix}bugdokumen 𝟘%
│₹⃟ぁ ➣  ${prefix}bugdokumenv2 𝟘%
│₹⃟ぁ ➣  ${prefix}sendallvirtex 𝟘%
│₹⃟ぁ ➣  ${prefix}katalog 𝟘%
│₹⃟ぁ ➣  ${prefix}katalogv2 𝟘%
│₹⃟ぁ ➣  ${prefix}katalogv3 𝟘%
│₹⃟ぁ ➣  ${prefix}jadic [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadicv2 [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadicv3 [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadicv4 [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadicv5 [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadicgb [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirgam [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirgamv2 [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirgamv3 [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}tovirgam [tag Sticker] 𝟘%
│₹⃟?? ➣  ${prefix}tovirgamv2 [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}tovirgamv3 [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugtroli 𝟘%
│₹⃟ぁ ➣  ${prefix}troli 𝟘%
│₹⃟ぁ ➣  ${prefix}troliv2 𝟘%
│₹⃟ぁ ➣  ${prefix}bugsungsw 𝟘%
│₹⃟ぁ ➣  ${prefix}bugsungswv2 𝟘%
│₹⃟ぁ ➣  ${prefix}bugcombine 𝟘%
│₹⃟ぁ ➣  ${prefix}buglokasi 𝟘%
│₹⃟ぁ ➣  ${prefix}buglokasiv2 𝟘%
│₹⃟ぁ ➣  ${prefix}allbuglokasi 𝟘%
│₹⃟ぁ ➣  ${prefix}buglociphone 𝟘%
│₹⃟ぁ ➣  ${prefix}buglocandro [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugliveloc 𝟘%
│₹⃟ぁ ➣  ${prefix}virlok [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugimg 𝟘%
│₹⃟ぁ ➣  ${prefix}bugimgv2 𝟘%
│₹⃟ぁ ➣  ${prefix}bugr 𝟘%
│₹⃟ぁ ➣  ${prefix}bughole 𝟘%
│₹⃟ぁ ➣  ${prefix}superhole 𝟘%
│₹⃟ぁ ➣  ${prefix}bugweb [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugwebv2 [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}buglink 𝟘%
│₹⃟ぁ ➣  ${prefix}buggif 𝟘%
│₹⃟ぁ ➣  ${prefix}kurzxddgx 𝟘%
│₹⃟ぁ ➣  ${prefix}bugarawareal 𝟘%
│₹⃟ぁ ➣  ${prefix}bugarawa 𝟘%
│₹⃟ぁ ➣  ${prefix}bugarawaza 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirus [Reply] 𝟘
│₹⃟ぁ ➣  ${prefix}bugvideo 𝟘%
│₹⃟ぁ ➣  ${prefix}bugvideov2 𝟘%
│₹⃟ぁ ➣  ${prefix}zextz 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirtex [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadivirtexv2 [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}spamvirtex [Total] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugnulis [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}bugneon [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}buginvite 𝟘%
│₹⃟ぁ ➣  ${prefix}bugtagall [teks] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadiphilips [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadiphilipsv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugpdf [teks] [tag gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugpdfv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugjson [teks] [tag Gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugjsonv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugjs [teks] [tag Gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugjsv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugxml [teks] [tag Gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugxmlv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugzip [teks] [tag Gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibugzipv2 [teks] [tag Sticker] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibug7z [teks] [tag Gambar] 𝟘%
│₹⃟ぁ ➣  ${prefix}jadibug7zv2 [teks] [tag Sticker] 𝟘%
╰───────────❏
...
case 'info':
case 'informasi':
tekss = `┏━➤ 「 𝙄𝙉𝙁𝙊 𝘽𝙊𝙏 」\n┃┃✯ Nama Bot : ${botname}\n┃┃✯ Prefix : Multi\n┃┃✯ Platform : Gaje\n┃┃✯ Runtime : ${runtime(process.uptime())}\n┃┃✯ Sc Bot : Subscribe DEFFBOTz Untuk Up Selanjutnya.\n┗━━━━━━━Hai ${pushname} 👋\n\n✍️Script Made By DEFFBOTz\n☠️Version : 1.0\n🐧Channel YT : https://youtube.com/channel/UCx6TnPIwwnMJM59XoUUInIw :)\n*Subscribe For New Update!*`
trans = `${ownername}`
but = [
...
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp2?apikey=beta&text=${encodeURI(q)}`)
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe © DEFFBOTz `)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe © DEFFBOTz `)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe © DEFFBOTz ' })
fs.unlinkSync(ran)
})
break
...
if (pesan.length > 300) return pras.zeroyt7.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', text, { quoted: ftrol })
var nomor = mek.participant
const teks1 = `*[© DEFFBOTzBotz]*\nNomor : @${nomor.split("@s.whatsapp.net")[0]}\nPesan : ${pesan}`
var options = {
text: teks1,
contextInfo: { mentionedJid: [nomor] },
}
zeroyt7.sendMessage(`6282132805286@s.whatsapp.net`, options, text, { quoted: ftrol })
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
break
case 'ttnowm': 
      case 'tiktoknowm':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
break
//━━━━━━━━━━━━━━━[ FITUR ANIME ]━━━━━━━━━━━━━━━━━//

case 'kapankah':
				if (args.length < 1) return zeroyt7.sendMessage(from, 'Pertanyaan nya apa?', text, {quoted: mek})
				kapankah = q
...
if (args.length == 0) return reply(`Nama Yg Mau Dicari Mana Tod\nContoh: ${prefix + command}  Zextz High`)
query = args.join(" ")
...
zeroyt7.sendMessage(from, buff1, image, {quoted: mek, caption: '_Nih kak cowoknya_'})
buff2 =await getBuffer (anu.result.female)
zeroyt7.sendMessage(from, buff2, image, {quoted: mek, caption: '_Nih kak ceweknya_'})
break
case 'renungan':
case 'meme': 
reply(`Lagi Error Kak`)
ini = await fetchJson(`https://apidhani.herokuapp.com/api/randomimage/${command}?apikey=NisaaCantik}`)
buffer = await getBuffer(ini.result.result)
zeroyt7.sendMessage(from, buffer, image, {quoted: mek, caption: '*Nih Kak*'})
break
case 'quotesimage':
reply(`Lagi Error Kak`)
break
...
zeroyt7.sendMessage(from, random, image, {quoted: mek, caption: '_Nih Kak_'})
break
...
reply(mess.wait)
buffer = await getBuffer(ini.result.result)
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
break
case 'asupancecan':
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
break
case 'asupanhijaber':
...
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/xnxx?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
break
...
zeroyt7.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe © DEFFBOTz '})
})
break
case 'randomdarkjoke':
...
┃┃✯ Runtime : ${runtime(process.uptime())}
┃┃✯ Sc Bot : https://youtube.com/channel/UCx6TnPIwwnMJM59XoUUInIw
┗━━━━━━━`
gam = fs.readFileSync('./media/deff.jpg')
but = [
...
│
└──────[ GITHUB ]──────❒
  │◦➛Script Ory :Zextz High
  │◦➛-
  │◦➛Script Recode : DEFFBOTz
  │◦➛-
  └──────────────────❒`
but = [
{ buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
...
but = [
        ...
        sendButImage(from, kimak, "© DEFFBOTz ", gam, but)
break
case 'donasi':
...
gam = fs.readFileSync('./media/deff.jpg')
but = [
          { buttonId: `${prefix}ovo`, buttonText: { displayText: 'QR OVO' }, type: 1 },
          { buttonId: `${prefix}dana`, buttonText: { displayText: 'QR DANA' }, type: 1 },
          { buttonId: `${prefix}gopay`, buttonText: { displayText: 'QR GOPAY' }, type: 1 }
        ]
        sendButImage(from, teks, "© DEFFBOTz ", gam, but)
break
...
anu = await fetchJson(`https://apidhani.herokuapp.com/api/game/tebakgambar?apikey=NisaaCantik`)
get = `*${anu.result.soal}*`
setTimeout( () => {
zeroyt7.sendMessage(from, 'Jawaban: '
+anu.result.jawaban, text, {quoted: ftrol}) 
...
setTimeout( () => {
zeroyt7.sendMessage(from, ngebuff, image, { caption: '_Tebak bro!!! gak bisa jawab wajib subrek © DEFFBOTz  :v_', quoted: ftrol }) 
}, 0) // 1000 = 1s,
break
case 'tembak':
...
case 'bokep1':				 
 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
qute = fs.readFileSync('./media/deff.jpg') 
...
break
			   ...
			   reply('Mode Sange!!..')
                ...
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www2.zippyshare.com/d/z9dcY6Nr/791216/%5bNekoPoi%5d_Akina_to_Onsen_de_H_Shiyo%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi2':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www4.zippyshare.com/d/j7PFLGUY/946757/%5bNekoPoi%5d_Tsuma_ga_Kirei_ni_Natta_Wake_-_02_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi3':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www111.zippyshare.com/d/EK5uqIMh/566060/%5bNekoPoi%5d_Megane_no_Megami_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi4':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www109.zippyshare.com/d/2ebALhhS/463654/%5bNekoPoi%5d_Watashi_ga_Toriko_-_02%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi5':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www115.zippyshare.com/d/LmzOkRAI/313299/%5bNekoPoi%5d_Chichi-iro_Toiki_-_01_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi6':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www89.zippyshare.com/d/SgEHvrJs/42812/%5bNekoPoi%5d_Chichi-iro_Toiki_-_02_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi7':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www66.zippyshare.com/d/j0ivbciL/520411/%5bNekoPoi%5d_Onna_Maou_Melissa_no_H_na_Boukenki_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi8':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www71.zippyshare.com/d/M225YIrR/535656/%5bNekoPoi%5d_Buta_no_Gotoki_Sanzoku_ni_Torawarete_Shojo_wo_Ubawareru_Kyonyuu_Himekishi_Onna_Senshi_-_01%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
                 case 'nekopoi9':
                 reply('Mode Sange!!..')
                 if (!isOwner) return reply('LU BUKAN OWNER GBLOK')
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                zeroyt7.sendMessage(from, fcrew, MessageType.image, {quoted: mek, caption: 'NIH LINKNYA: https://www49.zippyshare.com/d/bdwYjaXS/605790/%5bNekoPoi%5d_Akebi_no_Hana___Maho_-_01_%5b360P%5d_%5bnekopoi.pro%5d.mp4\n\nNOTE SIAPKAN TISU'})
                  break
...
https://nhentai.net/g/238876/
Happy Mother's Day 165310,177978,211759,212643,229540, 250029,211519,256097,163478, 91505, 79280, 260629,128051,121972,261633,172044,119055,208323,149942,161236, 177150,233766,97949,230107 ,175822, 213545,232837,179166,138603,130183, 173543,234642,268015,228293,268893, 239536, yg suka mamah muda
...
Random
 257892 226942 236297 216039 221711 245304 166174 175220 244327 191049 220882 244859 227446 259328 259532 259634 259610 259348 258669 256097 118282 260028 260058 259557 259497 122220 260111 260088 259880 258977 260097 259765 259359 260138 259617 107965 197255 260276 260209 260210 260203 191360 191390 248933 257567 227913 211648 210240 260626 259622 257991 213966 260623 149112 257168 198203 114783 220958 244387 243734 223315 118069 136188 260686 241777  260912 142154 119798 261174 258301 256808 169134 220354 260271 261725 261378 252174 261928 114427 187003 147577 249458 157767 224316 175294 258450 233864 236128 261162 174036 187205 210873 193318 110232 199310 193816 220376 193814 193815 219068 220386 177642 188269 181837 220377 119293 257528 258926 262384 105951 259904 208174 249229 245644 262538 234818 216845 149212 134442 135927 262447 261811 261650 261225 261226 260761 250327 192327 167801 150309 123554`
				zeroyt7.sendMessage(from, { contentText: `${menu}`, buttons: [{ buttonId: `${prefix}owner`, buttonText: { displayText: 'ᴏᴡɴᴇʀ' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: 'sᴇᴡᴀʙᴏᴛ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
				break
	...
	teks =
`
[!] note untuk yang mau donasi scan code
di atas atau masukan no gopay di bawah thank

╭━━⬣ 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 𝐓𝐈𝐌𝐄
┃𝙂𝙊𝙋𝘼𝙔 = _${nogopay}_ (${donname})
┃𝙃𝙪𝙗 = _${nogopay}_
╰⬣

`
gam = fs.readFileSync('./zeroyt7/gopay.jpg')
but = [
          { buttonId: `${prefix}igfyg`, buttonText: { displayText: 'NGGAK JADI 😄    \n\n\n\ EHH JADI BANG GW PUNYA UANG BANYAK SUMPAH' }, type: 1 },
          { buttonId: `${prefix}igf0g`, buttonText: { displayText: 'IYA BANG 🤗' }, type: 1 }
        ]
        sendButImage(from, teks, "© DEFFBOTz ", gam, but)
break
case 'ovo':
...
╭━━⬣ 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 𝐓𝐈𝐌𝐄
┃𝙊𝙑𝙊 = _${noovo}_ (${donname})
┃𝙃𝙪𝙗 =  _${nodana}_
╰⬣

`
gam = fs.readFileSync('./zeroyt7/ovo.jpg')
but = [
          { buttonId: `${prefix}igfyg`, buttonText: { displayText: 'NGGAK JADI 😄    \n\n\n\ EHH JADI BANG GW PUNYA UANG BANYAK SUMPAH' }, type: 1 },
          { buttonId: `${prefix}igf0g`, buttonText: { displayText: 'IYA BANG 🤗' }, type: 1 }
        ]
...
╭━━⬣ 𝐈𝐍𝐃𝐎𝐍𝐄𝐒𝐈𝐀 𝐓𝐈𝐌𝐄
┃𝘿𝘼𝙉𝘼 = _${nodana}_ (${donname})
┃𝙃𝙪𝙗 =  _${nodana}_
╰⬣

`
gam = fs.readFileSync('./zeroyt7/dana.jpg')
but = [
          { buttonId: `${prefix}igfyg`, buttonText: { displayText: 'NGGAK JADI 😄    \n\n\n\ EHH JADI BANG GW PUNYA UANG BANYAK SUMPAH' }, type: 1 },
          { buttonId: `${prefix}igf0g`, buttonText: { displayText: 'IYA BANG 🤗' }, type: 1 }
        ]
